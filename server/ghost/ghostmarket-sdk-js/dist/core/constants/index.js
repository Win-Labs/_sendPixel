...
exports.AddressesByChain = exports.ChainCurrency = exports.ChainFullName = exports.PHA_TESTNET_CONTRACTS = exports.PHA_MAINNET_CONTRACTS = exports.FLOW_TESTNET_ADDRESSES = exports.FLOW_MAINNET_ADDRESSES = exports.SOLANA_TESTNET_ADDRESSES = exports.SOLANA_MAINNET_ADDRESSES = exports.BLAST_MAINNET_ADDRESSES = exports.BLAST_TESTNET_ADDRESSES = exports.SHARDEUM_MAINNET_ADDRESSES = exports.SHARDEUM_TESTNET_ADDRESSES = exports.NEOX_MAINNET_ADDRESSES = exports.NEOX_TESTNET_ADDRESSES = exports.BASE_TESTNET_ADDRESSES = exports.BASE_MAINNET_ADDRESSES = exports.N3_TESTNET_ADDRESSES = exports.N3_MAINNET_ADDRESSES = exports.BSC_TESTNET_ADDRESSES = exports.BSC_MAINNET_ADDRESSES = exports.POLYGON_TESTNET_ADDRESSES = exports.POLYGON_MAINNET_ADDRESSES = exports.AVALANCHE_TESTNET_ADDRESSES = exports.AVALANCHE_MAINNET_ADDRESSES = exports.ETHEREUM_TESTNET_ADDRESSES = exports.ETHEREUM_MAINNET_ADDRESSES = exports.DEV_API_URL = exports.TESTNET_API_URL = exports.MAINNET_API_URL = exports.API_PATH = exports.SITE_HOST_TESTNET = exports.SITE_HOST_MAINNET = exports.API_BASE_DEV = exports.API_BASE_TESTNET = exports.API_BASE_MAINNET = exports.ORDERBOOK_VERSION = exports.MIN_BID_INCREASE_BPS = exports.GHOSTMARKET_TRADE_FEE_BPS = void 0;
const gm_api_js_1 = require("@onblockio/gm-api-js");
/* eslint-disable prettier/prettier */
exports.GHOSTMARKET_TRADE_FEE_BPS = 200;
exports.MIN_BID_INCREASE_BPS = 500;
exports.ORDERBOOK_VERSION = 2;
exports.API_BASE_MAINNET = 'https://api.ghostmarket.io';
exports.API_BASE_TESTNET = 'https://api-testnet.ghostmarket.io';
exports.API_BASE_DEV = 'https://api-dev.ghostmarket.io';
exports.SITE_HOST_MAINNET = 'https://ghostmarket.io';
exports.SITE_HOST_TESTNET = 'https://testnet.ghostmarket.io';
exports.API_PATH = `/api/v${exports.ORDERBOOK_VERSION}`;
exports.MAINNET_API_URL = `${exports.API_BASE_MAINNET}${exports.API_PATH}`;
exports.TESTNET_API_URL = `${exports.API_BASE_TESTNET}${exports.API_PATH}`;
exports.DEV_API_URL = `${exports.API_BASE_DEV}${exports.API_PATH}`;
exports.ETHEREUM_MAINNET_ADDRESSES = {
...
exports.ETHEREUM_TESTNET_ADDRESSES = {
...
exports.AVALANCHE_MAINNET_ADDRESSES = {
...
exports.AVALANCHE_TESTNET_ADDRESSES = {
...
exports.POLYGON_MAINNET_ADDRESSES = {
...
exports.POLYGON_TESTNET_ADDRESSES = {
...
exports.BASE_MAINNET_ADDRESSES = {
...
exports.BASE_TESTNET_ADDRESSES = {
...
exports.NEOX_TESTNET_ADDRESSES = {
    ...
    WRAPPED_TOKEN: '0x1CE16390FD09040486221e912B87551E4e44Ab17',
    GHOST_ERC721: '0x26D583e2CDa958b13CC319FAd124aa729f8A196e',
    GHOST_ERC1155: '0x44C5CE28c29934B71A2a0447745d551DfC7B5133',
    LP_TOKEN: '',
    LP_STAKING: '',
};
exports.NEOX_MAINNET_ADDRESSES = {
    EXCHANGE: '0x49CaC1f0564Ed70a30C2454F653a3A1058D6A9bA',
    INCENTIVES: '0x53C7F0c5e2547d2F2223D7Ba92F788d46c28F263',
    GM_TOKEN: '0x42bD1B1c84aD8Cf576D25FCd86A7EFbE2752Fe02',
    ROYALTIES: '0x596a6fFC1525193E49C71476BAa8a9D071A8a2a3',
    PROXY_NFT: '0x204965aa9fd13D455DB38331788fd1DD509a969d',
    PROXY_ERC20: '0xFC2eb99ABAe550903a41DafCb6D797BcD0D88758',
    WRAPPED_TOKEN: '0xdE41591ED1f8ED1484aC2CD8ca0876428de60EfF',
    GHOST_ERC721: '0x0B53b5dA7d0F275C31a6A182622bDF02474aF253',
    GHOST_ERC1155: '0x35609dC59E15d03c5c865507e1348FA5abB319A8',
    LP_TOKEN: '',
    LP_STAKING: '',
};
exports.SHARDEUM_TESTNET_ADDRESSES = {
    EXCHANGE: '',
    INCENTIVES: '',
    GM_TOKEN: '',
    ROYALTIES: '',
...
exports.SHARDEUM_MAINNET_ADDRESSES = {
    EXCHANGE: '',
    INCENTIVES: '',
    GM_TOKEN: '',
    ROYALTIES: '',
...
exports.BLAST_TESTNET_ADDRESSES = {
    EXCHANGE: '',
    INCENTIVES: '',
    GM_TOKEN: '',
    ROYALTIES: '',
...
exports.BLAST_MAINNET_ADDRESSES = {
    EXCHANGE: '',
    INCENTIVES: '',
    GM_TOKEN: '',
    ROYALTIES: '',
...
exports.SOLANA_MAINNET_ADDRESSES = {
    EXCHANGE: '',
    INCENTIVES: '',
    GM_TOKEN: '',
    ROYALTIES: '',
...
exports.SOLANA_TESTNET_ADDRESSES = {
    EXCHANGE: '',
    INCENTIVES: '',
    GM_TOKEN: '',
    ROYALTIES: '',
...
exports.PHA_MAINNET_CONTRACTS = {
    EXCHANGE: '',
    INCENTIVES: '',
    GM_TOKEN: '',
    GHOST_PEPE12: ''
};
exports.PHA_TESTNET_CONTRACTS = {
    EXCHANGE: '',
    INCENTIVES: '',
    GM_TOKEN: '',
    GHOST_PEPE12: ''
...
var ChainFullName;
(function (ChainFullName) {
    ChainFullName["avalanche"] = "Avalanche";
    ChainFullName["avalanchet"] = "Avalanche Testnet";
    ChainFullName["bsc"] = "BSC";
    ChainFullName["bsct"] = "BSC Testnet";
    ChainFullName["eth"] = "Ethereum";
    ChainFullName["etht"] = "Ethereum Testnet";
    ChainFullName["polygon"] = "Polygon";
    ChainFullName["polygont"] = "Polygon Testnet";
    ChainFullName["n3"] = "Neo3";
    ChainFullName["n3t"] = "Neo3 Testnet";
    ChainFullName["pha"] = "Phantasma";
    ChainFullName["phat"] = "Phantasma Testnet";
    ChainFullName["base"] = "Base";
    ChainFullName["baset"] = "Base Testnet";
    ChainFullName["shardeum"] = "Shardeum";
    ChainFullName["shardeumt"] = "Shardeum Testnet";
    ChainFullName["neox"] = "NeoX";
    ChainFullName["neoxt"] = "NeoX Testnet";
    ChainFullName["blast"] = "Blast";
    ChainFullName["blastt"] = "Blast Testnet";
})(ChainFullName = exports.ChainFullName || (exports.ChainFullName = {}));
var ChainCurrency;
(function (ChainCurrency) {
    ChainCurrency["avalanche"] = "AVAX";
    ChainCurrency["avalanchet"] = "AVAX";
    ChainCurrency["bsc"] = "BNB";
    ChainCurrency["bsct"] = "BNB";
    ChainCurrency["eth"] = "ETH";
    ChainCurrency["etht"] = "ETH";
    ChainCurrency["polygon"] = "MATIC";
    ChainCurrency["polygont"] = "MATIC";
    ChainCurrency["n3"] = "GAS";
    ChainCurrency["n3t"] = "GAS";
    ChainCurrency["pha"] = "KCAL";
    ChainCurrency["phat"] = "KCAL";
    ChainCurrency["base"] = "ETH";
    ChainCurrency["baset"] = "ETH";
    ChainCurrency["shardeum"] = "SHM";
    ChainCurrency["shardeumt"] = "SHM";
    ChainCurrency["neox"] = "GAS";
    ChainCurrency["neoxt"] = "GAS";
    ChainCurrency["blast"] = "ETH";
    ChainCurrency["blastt"] = "ETH";
})(ChainCurrency = exports.ChainCurrency || (exports.ChainCurrency = {}));
exports.AddressesByChain = {
    [gm_api_js_1.ChainNetwork.Avalanche]: exports.AVALANCHE_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.AvalancheT]: exports.AVALANCHE_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.Bsc]: exports.BSC_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.BscT]: exports.BSC_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.Eth]: exports.ETHEREUM_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.EthT]: exports.ETHEREUM_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.Polygon]: exports.POLYGON_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.PolygonT]: exports.POLYGON_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.N3]: exports.N3_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.N3T]: exports.N3_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.Pha]: exports.PHA_MAINNET_CONTRACTS,
    [gm_api_js_1.ChainNetwork.PhaT]: exports.PHA_TESTNET_CONTRACTS,
    [gm_api_js_1.ChainNetwork.Base]: exports.BASE_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.BaseT]: exports.BASE_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.Shardeum]: exports.SHARDEUM_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.ShardeumT]: exports.SHARDEUM_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.NeoX]: exports.NEOX_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.NeoXT]: exports.NEOX_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.Blast]: exports.BLAST_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.BlastT]: exports.BLAST_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.Solana]: exports.SOLANA_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.SolanaT]: exports.SOLANA_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.Flow]: exports.FLOW_MAINNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.FlowT]: exports.FLOW_TESTNET_ADDRESSES,
    [gm_api_js_1.ChainNetwork.Unknown]: undefined,
    [gm_api_js_1.ChainNetwork.All]: undefined
};
